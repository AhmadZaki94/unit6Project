...
export const Cart = () => {
    ...
    return (
        <Box w='680px' m='auto' mt='50px' border='1px solid transparent' fontFamily='"Trade Gothic W01 Light", Arial, sans-serif'>
...
return (
    <Box key={id} m='auto' boxShadow="rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px"  width={'fit-content'} margin='auto' marginBottom='2rem'>
